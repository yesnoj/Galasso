...
async function main() {
  ...
  const reqs = [
    ...
    ['req-2-1','area-2','2.1','Progettazione delle attività','Per ogni attività sociale deve esistere documentazione.','Sono presenti progetti, accordi formalizzati o documentazione equivalente per le attività sociali?','["Progetti individuali","Convenzioni","Accordi con enti/associazioni","Progetti collettivi"]',1,4],
    ...
    ['req-2-3','area-2','2.3','Impegno all inclusione','L organizzazione deve adottare un impegno formale all inclusione.','L organizzazione ha adottato un impegno formale all inclusione?','["Dichiarazione di impegno","Politica inclusione/non discriminazione"]',1,6],
